...
def main():
    ...
    results_df.to_csv("prompt_injection_results_mistral_small_latest.csv", index=False)
    print("Evaluation completed. Results saved to prompt_injection_results_mistral_small_latest.csv")
